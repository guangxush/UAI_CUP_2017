...
def generate_test(input_file, output_file):
    ...
    # 读取天气信息将其转换成字典(key:day,value:(key:hour,value:weathercode))
    ...
    for input_line in input_lines:
        ...
        weather_condition = weather_record.get(line[3] + ',' + line[4], '30,6.6')
        ...
        temp_line = ','.join(start_poi + end_poi + weather_condition +
                             [day_of_the_week, create_hour, start_point, end_point]) + '\n'
...
if __name__ == '__main__':
    in_file = sys.argv[1]
    out_file = sys.argv[2]
    generate_test(in_file, out_file)
